<table border="1">
    ...
    foreach ($params['datos'] as $usuario):
        ...
        <tr>
            ...
            ?>
            <td>
                <a href="index.php?action=modificarUsuario&usuario=<?= $usuario['nombre'] ?>" title="Modificar usuario">Modificar</a>
            </td>
            <td>
                <a href="index.php?action=eliminarUsuario&usuario=<?= $usuario['nombre'] ?>" title="Eliminar usuario">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
</table>
